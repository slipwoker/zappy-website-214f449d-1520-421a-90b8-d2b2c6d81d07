  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
      ...
      contactForm.addEventListener('submit', function(e) {
        ...
        var errorElements = contactForm.querySelectorAll('.form-error');
        for (var i = 0; i < errorElements.length; i++) {
          errorElements[i].textContent = '';
        }
        var invalidFields = contactForm.querySelectorAll('.is-invalid');
      ...
      contactForm.addEventListener('blur', function(e) {
        ...
        if (!field.hasAttribute('required') && field.type !== 'email') return;

        var value = field.value.trim();
        var errorEl = field.parentNode ? field.parentNode.querySelector('.form-error') : null;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '214f449d-1520-421a-90b8-d2b2c6d81d07',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '214f449d-1520-421a-90b8-d2b2c6d81d07';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '214f449d-1520-421a-90b8-d2b2c6d81d07';
